...
class Widget extends Component {
    ...
    onClick = e => {
        ...
        this.setState({
            ...
            filteredSuggestions: [],
            showSuggestions: false,
            userInput: this.state.userInput.slice(0, -2) + e.currentTarget.innerText.replace(/ *\([^)]*\) */g, "")
        });
    };
    ...
    onKeyDown = e => {
        ...
        if (e.keyCode === 13 && this.state.showSuggestions) {
            ...
            this.setState({
                activeSuggestion: 0,
                showSuggestions: false,
                userInput: this.state.userInput.slice(0, -2) + filteredSuggestions[activeSuggestion].replace(/ *\([^)]*\) */g, "")
            });
        }
        // User pressed the up arrow, decrement the index
        else if (e.keyCode === 38 && this.state.showSuggestions) {
